...
import { Sccmptedt5plistPage } from '../sccmptedt5plist/sccmptedt5plist';
...
@IonicPage()
@Component({
  selector: 'page-sccmptedt5pdetails',
  templateUrl: 'sccmptedt5pdetails.html',
})

export class Sccmptedt5pdetailsPage {
