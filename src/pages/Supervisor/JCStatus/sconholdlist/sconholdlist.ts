...
@IonicPage()
@Component({
  selector: 'page-sconholdlist',
  templateUrl: 'sconholdlist.html',
})

export class SconholdlistPage {
  ...
  ngOnInit(val) {
    ...
    if (this.global.CheckInternetConnection()) {
      ...
      this.httpClient.get<any>(this.global.HostedPath + "GetOnHoldJobCardList?BranchID=" + this.global.UserDetails[0].BranchID).subscribe(jobCards => {
