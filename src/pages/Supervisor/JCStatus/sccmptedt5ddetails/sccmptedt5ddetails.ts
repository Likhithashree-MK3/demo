...
import { Sccmptedt5dlistPage } from '../sccmptedt5dlist/sccmptedt5dlist';
...
@IonicPage()
@Component({
  selector: 'page-sccmptedt5ddetails',
  templateUrl: 'sccmptedt5ddetails.html',
})

export class Sccmptedt5ddetailsPage {
