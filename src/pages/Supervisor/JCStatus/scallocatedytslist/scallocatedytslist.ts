...
@IonicPage()
@Component({
  selector: 'page-scallocatedytslist',
  templateUrl: 'scallocatedytslist.html',
})

export class ScallocatedytslistPage {
  ...
  ngOnInit(val) {
    ...
    if (this.global.CheckInternetConnection()) {
      ...
      this.httpClient.get<any>(this.global.HostedPath + "GetAllocatedYTSJobCardList?BranchID=" + this.global.UserDetails[0].BranchID).subscribe(jobCards => {
